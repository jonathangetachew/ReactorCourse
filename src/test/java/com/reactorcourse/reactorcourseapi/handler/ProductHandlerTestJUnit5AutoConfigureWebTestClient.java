...
@SpringBootTest
@AutoConfigureWebTestClient // used to Autowire the webTestClient below pre-configured since @WebFluxTest only works with controllers and not RouterFunctions
class ProductHandlerTestJUnit5AutoConfigureWebTestClient {
    ...
    void setUp() {
        /**
         * mutate() used to modify the webClient(Autowired) and change the configuration, WORKS WITH CONTROLLER TESTS AS WELL!!!
         */
        webTestClient =
                webTestClient
                        .mutate()
